                ...
                <div class="row">
                    <div class="col-lg-12">
                        <footer role="contentinfo">
                            <p class="left">NogSystem 1.0.12</p>
        ...
        <script type="text/javascript" href="<?php echo base_url('assets/theme'); ?>/js/bootstrap.min.js"></script>
        <script type="text/javascript" href="<?php echo base_url('assets/theme'); ?>/js/twitter-bootstrap-hover-dropdown.min.js"></script>
        <script type="text/javascript" href="<?php echo base_url('assets/theme'); ?>/js/bootstrap-admin-theme-change-size.js"></script>
        <script type="text/javascript" src="<?php echo base_url('assets/theme'); ?>/vendors/easypiechart/jquery.easy-pie-chart.js"></script>
